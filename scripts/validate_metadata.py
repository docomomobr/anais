...
# Whitelist of columns that can be used in dynamic SQL UPDATE statements
_VALID_COLS = frozenset({
    'abstract', 'abstract_en', 'abstract_es',
    'keywords', 'keywords_en', 'keywords_es',
    'references_', 'locale',
    'title', 'subtitle', 'title_en', 'subtitle_en', 'title_es', 'subtitle_es',
})
...
def check_abstract_contamination(article):
    ...
    for field_name in ('abstract', 'abstract_en', 'abstract_es'):
        ...
        template_markers = ['máximo de', 'fonte Arial', 'espaçamento simples',
                           'máximo de 1000 caracteres', 'parágrafo de']
        for marker in template_markers:
            if marker in text.lower():
                problems.append(f'contém template de formulário ("{marker}")')
                break
