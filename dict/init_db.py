...
SIGLAS = [
    ...
    # Outros
    'ABEA', 'ANTAC', 'CBCM', 'IPESP', 'PPGAU', 'PROARQ', 'PROPAR', 'PROURB',
...
LUGARES = {
    ...
    'serra': 'Serra',
    'cataguases': 'Cataguases', 'bauru': 'Bauru', 'barbalha': 'Barbalha',
    'jaú': 'Jaú', 'jaraguá': 'Jaraguá', 'uberaba': 'Uberaba',
    'antofagasta': 'Antofagasta', 'arica': 'Arica', 'atenas': 'Atenas',
    'barcelona': 'Barcelona', 'bogotá': 'Bogotá', 'caracas': 'Caracas',
    'chandigarh': 'Chandigarh', 'mendoza': 'Mendoza', 'osaka': 'Osaka',
    'moçambique': 'Moçambique', 'cariri': 'Cariri', 'paranoá': 'Paranoá',
    'mairinque': 'Mairinque', 'varginha': 'Varginha', 'passos': 'Passos',
    'louveira': 'Louveira', 'caruaru': 'Caruaru', 'manguinhos': 'Manguinhos',
...
EXPRESSOES = {
    ...
    'copacabana palace': 'Copacabana Palace',
