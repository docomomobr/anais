# GSC — Solicitações de indexação (2026-07-14)

Como fazer: no Search Console (conta tesouraria, propriedade
`https://anais.docomomobrasil.com/`), colar a URL na barra de inspeção
do topo → aguardar a análise → botão **"Solicitar indexação"** →
aguardar o teste (1-2 min) → "Indexação solicitada".
...
- [x] https://anais.docomomobrasil.com/brasil/sdbr15/
- [x] https://anais.docomomobrasil.com/nne/sdnne10/
...
**"Iniciar nova validação"** no balde "Rastreada, mas não indexada"
(14 mil págs): as 2 validações anteriores falharam em dias; a 3ª só
quando o Google digerir os 301 (URLs do OJS sumindo do índice) —
prevista para a 5ª medição, ~4 semanas.
