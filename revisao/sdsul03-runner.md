...
- [x] **3.7** Revisão eng.: 23 checks definidos=chamados, A28/A29/A30 handlers ok, ordem A29→A28→A19 correta, runner/pipeline coerentes (R10, 0.4 seções, 1.7-1.9 autores), 0 inconsistências
